...
PKG_NAME=hid-apple-4.2-dkms
PKG_VERSION=1.0.0
PKG_DESCRIPTION="Backported Apple human interface device module from kernel 4.2 including new MacBook hardware support."

MAINTAINER="Naftuli Tzvi Kay <rfkrocktk@gmail.com>"
HOMEPAGE="https://github.com/rfkrocktk/hid-apple-3.19"
